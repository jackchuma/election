...
describe("Election", function () {
  ...
  context("Limbo", async function() {
    ...
    it ("Only owner can set candA", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
      await expect(this.election.connect(this.alice).setCandA("Name A")).to.be.revertedWith("caller is not the owner");
    });
    ...
    it ("Only owner can set candB", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
    ...
    it ("Can only set candB during limbo", async function() {
    ...
    it ("Can set expectedVotes when election is in limbo", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
    ...
    it ("candA must be set to start new election", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
      await this.election.connect(this.owner).setCandB("Name B");
      await this.election.connect(this.owner).setExpectedVotes(10);
      await expect(this.election.connect(this.owner).newElection()).to.be.revertedWith("set candA");
    });

    it ("candB must be set to start new election", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
      await this.election.connect(this.owner).setCandA("Name A");
      await this.election.connect(this.owner).setExpectedVotes(10);
      await expect(this.election.connect(this.owner).newElection()).to.be.revertedWith("set candB");
    });

    it ("expectedVotes must be set to start new election", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
      await this.election.connect(this.owner).setCandA("Name A");
      await this.election.connect(this.owner).setCandB("Name B");
      await expect(this.election.connect(this.owner).newElection()).to.be.revertedWith("set expectedVotes");
    });

    it ("new election sets election as active", async function() {
      await this.election.connect(this.carol).voteB();
      await mineBlocks(10);
      await this.election.connect(this.owner).reset();
      await this.election.connect(this.owner).setCandA("Name A");
